...
def score_extract(true_bits, extracted_bits):
    ...
    true_bits = np.pad(true_bits, (M-len(true_bits), 0), 'constant', constant_values=0)
    extracted_bits = np.pad(extracted_bits, (M-len(extracted_bits), 0), 'constant', constant_values=0)
